...
| K | `PDF_Url` | Chuỗi (Text) | Đường dẫn tệp PDF hóa đơn lưu trên Google Drive |
| L | `So_CCCD` | Chuỗi (Text) | Số Căn cước công dân của khách hàng |
| M | `Hinh_CCCD_Truoc` | Chuỗi (Text) | Đường dẫn hình ảnh mặt trước thẻ CCCD của khách hàng lưu trên Google Drive |
| N | `Hinh_CCCD_Sau` | Chuỗi (Text) | Đường dẫn hình ảnh mặt sau thẻ CCCD của khách hàng lưu trên Google Drive |
